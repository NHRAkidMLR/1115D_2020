...
const char* redTitles[] = {"Left 1", "Left 2", "None", "None"};//left
const char* blueTitles[] = {"Right 1","Right 2", "None", "None"};//right
const char* skillsTitles[] = {"skills", "none", "none", "none"};
//functions are defined in autoPrograms, like skills(); or red1();
void (*redScripts[])() = {left1, left2, placeHolder, placeHolder};
void (*blueScripts[])() = {right1, right2, placeHolder, placeHolder};
...
void displayInit(void) {
	...
	lv_obj_t* redTab = lv_tabview_add_tab(tabview, "Left");//red
	lv_obj_t* blueTab = lv_tabview_add_tab(tabview, "Right");//blue
